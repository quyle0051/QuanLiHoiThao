...
<%--                                <a href="contract.jsp" class="dropdown-item">Hội Thảo B</a>--%>
<%--                                <a href="esd.jsp" class="dropdown-item">Hội Thảo C</a>--%>
    ...
    <div class="container-fluid pb-5 hero-header bg-light mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-lg-6">
                    <h1 class="display-1 mb-4 animated slideInRight"><span class="text-primary">HỌC HỎI - </span>KẾT NỐI - <span class="text-primary"> TRƯỞNG THÀNH.</span>
                        </h1>
                    <h5 class="d-inline-block border border-2 border-white py-3 px-5 mb-0 animated slideInRight">
                        HCMC University of Technology and Education</h5>
                </div>
                <div class="col-lg-6">
